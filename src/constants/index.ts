...
const techStack = [
  ...
  {
    category: "Backend",
    items: ["Node.js", "FastAPI", "Flask"],
  },
  {
    category: "Database",
    items: ["MongoDB", "PostgreSQL", "DrizzleORM"],
  },
  {
    category: "Dev Tools",
...
const WINDOW_CONFIG = {
  ...
  safariExperience: { isOpen: false, zIndex: INITIAL_Z_INDEX, data: null },
  safariLeadership: { isOpen: false, zIndex: INITIAL_Z_INDEX, data: null },
